...
from paad_rl.utils.dqn_core import DQN_Agent, model_get
from paad_rl.utils.schedule import *
from paad_rl.attacker.attacker import Huang_Attack, Pattanaik_Attack
    ...
    for j in range(num_updates):
        ...
        for step in range(args.num_steps):
            ...
            rollouts.insert(obs, recurrent_hidden_states, action,
                            action_log_prob, value, -reward,-reward_penalty, masks, bad_masks,args.weight,(j+1)*(step+1))
